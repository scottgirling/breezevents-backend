...
const updatedUserByUsername = (user_id: number, name: string, username: string, email: string, password_hash: string, bio: string, avatar_url: string) => {
    let queryValues = [];
...
module.exports = updatedUserByUsername;